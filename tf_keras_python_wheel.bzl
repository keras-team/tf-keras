...
def _tf_keras_python_wheel_repository_impl(repository_ctx):
...
tf_keras_python_wheel_repository = repository_rule(
    implementation = _tf_keras_python_wheel_repository_impl,
    attrs = {
