...
from tf_keras.layers.normalization import batch_normalization as batchnorm_v2
from tf_keras.layers.normalization import batch_normalization_v1 as batchnorm_v1
